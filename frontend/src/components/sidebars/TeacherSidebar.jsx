          ...
          <div className="flex items-center space-x-3 w-full">
            ...
            {!isCollapsed && (
              <div className="flex flex-col">
                ...
                <h2 className="text-indigo-300 dark:text-indigo-400 text-xs font-semibold">TEACHER PORTAL</h2>
              </div>
            )}
          </div>
            ...
            <div className="flex items-center gap-3 px-3 py-2 mb-2 rounded-lg bg-white/5 dark:bg-white/5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-indigo-300 dark:text-indigo-400 text-xs truncate">
                  {user?.email || 'teacher@elimuhub.school'}
                </p>
              </div>
            </div>
          )}
          ...
          `}>
            {!isCollapsed ? (
              <div>
                ...
                <p className="text-xs opacity-60">Teacher Portal v2.0</p>
              </div>
            ) : (

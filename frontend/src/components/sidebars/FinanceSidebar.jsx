...
function Sidebar() {
  ...
  return (
    <div className="relative h-full">
      ...
      <div 
        className={`
          h-screen bg-linear-to-b from-indigo-700 to-indigo-800 
          ...
          <div className="flex items-center space-x-3 w-full">
            ...
            {!isCollapsed && (
              <div className="flex flex-col">
                ...
                <h2 className="text-blue-200 text-xs font-semibold">FINANCE PORTAL</h2>
              </div>
            )}
          </div>
          ...
          `}>
            {!isCollapsed ? (
              ...
              <div className="rotate-90 whitespace-nowrap mt-8">
                <span className="font-semibold">©{new Date().getFullYear()} ElimuHub</span>
              </div>
            )}
          </div>
        </div>
